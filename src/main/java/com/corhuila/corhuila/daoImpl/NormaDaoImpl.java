...
public class NormaDaoImpl implements INormaDao{
	...
	public List<NormaDeroga> obtenerNormaDerogada(int norma) {
		...
		String sql = "select nd.nod_codigo, nd.nod_observacion, nd.nod_estado, dt.det_codigo, dt.det_nombre, nd.nor_codigo_padre, n.nor_nombre as nor_nombre_padre, nd.nor_codigo_hijo, nt2.not_nombre || ' ' || n2.nor_numero || ' ' || n2.nor_nombre as nor_nombre_hijo from general.norma_deroga nd "
